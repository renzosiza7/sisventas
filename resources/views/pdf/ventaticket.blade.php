    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="300px">
            ...
            <tr>
                ...
                <td><b>{{$v->tipo_documento}}:</b> {{$v->num_documento}}</td>
            ...
            <tr>
                ...
                <td><b>Nº de venta:</b> {{$v->serie_comprobante}}-{{$v->num_comprobante}}</td>

            </tr>

            <tr>

                <td><b>Fecha:</b> {{date('d-m-Y', strtotime($v->fecha_hora))}} </td>
        ...
        <table border="0" align="center" width="300px">
            ...
            <td align="right"><b>S/. {{number_format($v->total-($v->total*$v->impuesto),2)}}</b></td>
            ...
            <td align="right"><b>I.G.V. ({{$v->impuesto*100}}%)</b></td>

            <td align="right"><b>S/. {{number_format($v->total*$v->impuesto, 2)}}</b></td>
