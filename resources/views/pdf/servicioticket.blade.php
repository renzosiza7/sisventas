    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="300px">
            <tr>
                ...
                .::<strong>GRUPO CARDEÑA S.A.C.</strong>::.<br>
                R.U.C. 20539375866<br>
                Francisco Bolognesi Nº 712 Chivay - Arequipa, Perú - 962985509<br>
                </td>
            </tr>            
            <tr>
            <td align="center"></td>
            ...
            <tr>
                ...
                <td><b>Cliente:</b> {{$s->nombre}}</td>
            </tr>
            @if($s->num_documento != '')
                <tr>
                    <td><b>{{$s->tipo_documento}}:</b> {{$s->num_documento}}</td>
                </tr>
            @endif
            <tr>
                <td><b>Nº de servicio:</b> {{$s->serie_comprobante}}-{{$s->num_comprobante}}</td>
            </tr>  
            <tr>
                <td><b>Fecha:</b> {{date('d-m-Y', strtotime($s->fecha_hora))}} </td>
            </tr>  
        </table>
        @endforeach
        <br>
        ...
        <table border="0" align="center" width="300px">
            ...
            <td align="right"><b>S/. {{number_format($s->total-($s->total*$s->impuesto),2)}}</b></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            <td align="right"><b>I.G.V. ({{$s->impuesto*100}}%)</b></td>
            <td align="right"><b>S/. {{number_format($s->total*$s->impuesto,2)}}</b></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            <td align="right"><b>TOTAL</b></td>
            <td align="right"><b>S/. {{$s->total}}</b></td>
            </tr>
            @endforeach
            <tr>
            <td colspan="3">&nbsp;</td>
            ...
            <tr>
            <td colspan="3" align="center">¡Gracias por solicitar nuestros servicios!</td>
            </tr>
            <tr>
