...
?>
@include('facturacion.ApiFacturacion')
<?php
//ENVIO DE COMPROBANTE A SUNAT
$ruta_certificado = public_path();
$ruta_archivo_xml = public_path() . '/';
$ruta_archivo_cdr = public_path() . '/cdr/';

$objApi = new ApiFacturacion();

$objApi->EnviarComprobanteElectronico($emisor,$nombrexml,$ruta_certificado,$ruta_archivo_xml,$ruta_archivo_cdr);
?>
</body>
</html>